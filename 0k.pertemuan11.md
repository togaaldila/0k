# Pertemuan ke 11 : Praktik Pemrograman Mikrocontroller 

## Topik Bahasan
Melakukan praktik dasar elektronika menggunakan beberapa tools seperti tinkercad,wokwi.

## Deskripsi
Mampu memahami struktur pemrograman Arduino dan menerapkan Serial Monitor serta Pulse Width Modulation pada Arduino

### Praktikum 1: Praktik Serial Monitor pada Arduino
Selesaikan langkah-langkah praktikum berikut ini menggunakan Tinkercad di browser Anda.


1. **Masuk ke https://www.tinkercad.com/ dan login**
   
![img.png](img.png)
 
2. Klik Design -> Circuit -> Create untuk membuat rangkaian baru.

![img1.png](img.png)
  
4. Pembuatan akun bisa dengan akun Google, Apple, atau membuat akun khusus Tinkercad.

5. Buka email dan konfirmasi pembuatan akun Tinkercad.
